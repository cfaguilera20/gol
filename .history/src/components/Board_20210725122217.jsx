...
const Board = (props) => {
    ...
    return (
        <>
            ...
            <button onClick={onNextGeneration(world)}>Next Generarion</button>
            <div className="world">
    ...
    nextGeneration() {
        ...
        for (let y = 0; y < this.size; y++) {
            ...
            for (let x = 0; x < this.size; x++) {
                ...
                const neighborsAlive = cell.getNeighborsAlive();
                const isAlive = cell.isAlive;
                const nextIsAlive = cell.nextGeneration(neighborsAlive);
